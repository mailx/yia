 ...
 * @property integer $fdColumns
 */
class SvcType extends ServiceActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SvcType the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('fdName, fdColumnID, fdColumns', 'required'),
			array('fdColumnID, fdColumns', 'numerical', 'integerOnly'=>true),
			array('fdName', 'length', 'max'=>32),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, fdName, fdColumnID, fdColumns', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('fdColumns',$this->fdColumns);
