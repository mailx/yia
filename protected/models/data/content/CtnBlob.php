...
/**
 * This is the model class for table "tbBlob".
 *
 * The followings are the available columns in table 'tbBlob':
 ...
 */
class CtnBlob extends ContentActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CtnBlob the static model class
	 */
